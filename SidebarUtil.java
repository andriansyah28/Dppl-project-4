...
public class SidebarUtil {
    ...
    private static JPanel createSidebar(MainAppFrame parentFrame, String activeView, boolean isAdmin) {
        ...
        if (isAdmin) {
            // --- PERBAIKAN: Teks menu dipersingkat ---
        ...
        logoutPanel.setBorder(new EmptyBorder(UITheme.PADDING_MEDIUM, 0, UITheme.PADDING_MEDIUM, 0));
    ...
    private static JButton createSidebarButton(MainAppFrame parentFrame, String text, String viewName, String activeView) {
        ...
        button.setBorder(new EmptyBorder(UITheme.PADDING_SMALL, UITheme.PADDING_SMALL, UITheme.PADDING_SMALL, UITheme.PADDING_SMALL));
        button.setOpaque(true); 
        if (isActive) {
            button.setBackground(UITheme.PRIMARY_LIGHT);
            button.setForeground(UITheme.PRIMARY_DARK);
        } else {
            button.setBackground(UITheme.withAlpha(UITheme.SIDEBAR_BACKGROUND, 0)); 
